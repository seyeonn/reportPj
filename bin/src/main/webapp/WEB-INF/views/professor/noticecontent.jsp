      ...
      <div class="col-md-9 order-md-2">
        <div class="my-3 p-3 bg-white rounded shadow-sm">
            ...
            <div style="float: right; display:inline-block; width: 900px;">
              ...
              <%--교수랑 TA만--%>
              <button class="btn btn-primary mx-2 my-sm-0" type="button" style="width: 100px; float: right" onClick = " location.href='/professor/inputscore?notice_no=${professorNotice.notice_no}'">점수부여</button>
              <%--교수만--%>
			  <form method="post">
