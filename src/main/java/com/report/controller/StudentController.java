...
public class StudentController {
	...
	@Autowired
	StudentUploadedFileService studentUploadedFileService;
	@Autowired
	...
	public String studentlecture1(Model model, @RequestParam("id") int id, Principal principal, Lecture lecture,
	...
	public String studentlecture2(Model model, @RequestParam("id") int id, Principal principal, Lecture lecture,
			StudentLecture studentLecture) {
		System.out.printf("%d\n", id);
		Student student = studentMapper.findByStudentId(principal.getName());
		List<Lecture> studentlectures1 = studentMapper.findByStudentLecture1(principal.getName());
	...
	public String studentPosting(Model model, Principal principal, @RequestParam("id") int id,
			StudentNotice newStudentNotice) {
	...
	public String studentContentDelete(Model model, Principal principal,
			@RequestParam("studentnotice_no") int studentnotice_no, @RequestParam("lecture_no") int lecture_no) {
	...
	@PostMapping(value = "lecturefile", params = "cmd=downloadLecturefile")
...
//		System.out.println(list1.get(0).getFile_name());
	...
	public String delete(Model model, @RequestParam("hw_no") int hw_no, @RequestParam("id") int id,
			@RequestParam("id2") int id2) throws Exception {
