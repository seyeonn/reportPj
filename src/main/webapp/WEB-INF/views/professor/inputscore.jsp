				...
				<div class="my-2 ">
					<form class="form-inline mt-2 mt-md-0">
						<input class="form-control mr-sm-2" type="text"
							placeholder="학생 이름으로 검색하기" aria-label="Search">
				...
				<form method="post">
							...
							<c:forEach var="homework" items="${homeworks}">
								<tr>
									...
									<td><form method="post" enctype="multipart/form-data">
											<button type="submit" name="cmd" value="downloadHomework"
												class="btn btn-primary">열람</button>
									...
									<td><input type="text" class="form-control" name="ranking"
										value="${homework.ranking}" style="width: 50px" /></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
					...
					<div style="float: right; display: inline-block; width: 900px;">
						<button class="btn btn-primary mx-2 my-sm-0" type="button"
							...
							onclick="location.href='noticecontent'">목록</button>
						<button type="submit" class="btn btn-primary my-2 my-sm-0"
							name="cmd" value="input" style="width: 100px; float: right">입력</button>
					</div>
				</form>
