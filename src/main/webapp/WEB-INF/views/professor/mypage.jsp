...
<%-- 			<c:choose>
				...
				<c:otherwise>
					<div class="mb-3 mx-5">
						<label>TA 비밀번호</label>
						<div class="student_number">
							<button class="btn btn-primary  my-sm-0" type="button" onclick="location='createta'"
								style="width: 140px;">TA 생성</button>
						</div>
					</div>
				</c:otherwise>
			</c:choose> --%>
        ...
        --%>
				...
				<div class="mb-3">
					<label for="email">이메일</label> <input type="email"
						class="form-control" id="email" placeholder="dmsdo1234@gmail.com">
				</div>


				<div class="mb-3">
					<label for="address">전화번호<span class="text-muted">&nbsp(-없이
							숫자만 입력해주세요.)</span></label> <input type="text" class="form-control"
						id="phonenumber" placeholder="01012341234" required>
				</div>

				<%--교수랑 학생만--%>
				<div class="mb-3">
					<label for="question">질문</label> <input type="text"
						class="form-control" id="password2" placeholder="가장 좋아하는 음식"
						required>
					<div class="invalid-feedback">비밀번호 재발급을 위한 질문을 입력해주세요.</div>
				</div>
				<div class="mb-3">
					<label for="answer">답</label> <input type="text"
						class="form-control" id="password3" placeholder="치킨" required>
					<div class="invalid-feedback">비밀번호 재발급을 위한 답을 입력해주세요.</div>
				</div>


				<div class="mb-3">
					<label for="address">비밀번호</label> <input type="password"
						class="form-control" id="password" placeholder="password" required>
				</div>
				<div class="mb-3">
					<label for="address">비밀번호 확인</label> <input type="password"
						class="form-control" id="password" placeholder="password" required>
				</div>
