...
<%--            &lt;%&ndash;                            <input type="hidden" name="notice_no" value="${ professorNotice.notice_no }" />&ndash;%&gt;--%>
<%--            &lt;%&ndash;                            <input type="hidden" name="lecture_no" value="${ lecture.lecture_no }" />&ndash;%&gt;--%>
<%--            &lt;%&ndash;                            <button class="btn btn-primary my-sm-0" type="submit" name="cmd" value="delete" style="width: 100px; float: right">삭제</button>&ndash;%&gt;--%>
<%--            &lt;%&ndash;                        </form>&ndash;%&gt;--%>
<%--            <button class="btn btn-primary mx-2 my-sm-0" type="button" style="width: 100px; float: right"--%>
