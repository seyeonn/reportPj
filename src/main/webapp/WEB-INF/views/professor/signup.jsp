...
<body class="bg-light">
  <div class="container">
    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
      ...
      <form:form method = "post" modelAttribute="professor" class="needs-validation" novalidate="novalidate">
        <hr class="mb-4">
        <div class="mb-3">
          <label>아이디</label>
          <div class="input-group">
          	<form:input path="id" class="form-control" placeholder="사용할 아이디를 입력주세요."  required="required"/>
        ...
        <div class="mb-3">
          <label>이름</label>
          <div class="input-group">
          	<form:input path="name" class="form-control" placeholder="반드시 실명이어야 합니다. ex)홍길동" required="required"/>
            <div class="invalid-feedback">
              이름을 입력해주세요.
            </div>
          </div>
        ...
        <div class="mb-3">
          ...
          <form:select path="department_no" class="custom-select d-block w-100"
                       itemValue="department_no" itemLabel="department_name" items="${ departments }" required="required"/>
          <div class="invalid-feedback">
            학과를 선택해주세요.
          </div>
        </div>
        ...
        <div class="mb-3">
          <label>전화번호</label>      
          <form:input path="professor_phone" class="form-control" placeholder="-없이 숫자만 입력해주세요." required="required"/>  
          <div class="invalid-feedback">
            전화번호를 입력해주세요.
          </div>
        </div>
        ...
        <div class="mb-3">
          <label>비밀번호</label>
          <input type="password" name="password1" id="pwd1" class="form-control" placeholder="password" required="required"/>
          <div class="invalid-feedback">
            비밀번호를 입력해주세요.
          </div>
        </div>
